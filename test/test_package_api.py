...
from swagger_client.apis.package_api import PackageApi
...
class TestPackageApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.package_api.PackageApi()
    ...
    def test_get_all_with_trashed_packages(self):
        """
        Test case for get_all_with_trashed_packages
