...
from swagger_client.apis.refund_api import RefundApi
...
class TestRefundApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.refund_api.RefundApi()

    def tearDown(self):
        pass

    def test_add_refund(self):
        """
        Test case for add_refund

        Create a new refund
        """
        pass

    def test_filter_refunds(self):
        """
        Test case for filter_refunds
